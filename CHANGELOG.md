...
### Added
- **Server-side YouTube Upload** for Codespaces version (fully working!)
- YouTube upload route `/upload-to-youtube` using googleapis library
- YouTube upload scope to server config
- Helpful CORS limitation message for GitHub Pages version

### Changed
- GitHub Pages version now shows informative message about YouTube upload limitations
